...
@TestStep(When)
def kill_mutation(
    self, where_clause, node=None, test=False, output_format=None, **query_kwargs
):
    """
...
@TestStep(When)
def kill_mutation_by_table(self, database, table, node=None, **query_kwargs):
    """
...
@TestStep(When)
def kill_mutation_by_id(self, database, table, mutation_id, node=None, **query_kwargs):
    """
...
def test_kill_mutation(
    self, where_clause, node=None, output_format=None, **query_kwargs
):
    """
