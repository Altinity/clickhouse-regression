...
@TestScenario
@Requirements(RQ_SRS_016_Kerberos_Configuration_MultipleKerberosSections("1.0"))
...
@TestScenario
@Requirements(RQ_SRS_016_Kerberos_Configuration_WrongUserRealm("1.0"))
...
@TestScenario
@Requirements(RQ_SRS_016_Kerberos_Configuration_MultipleAuthMethods("1.0"))
...
@TestScenario
@Requirements(RQ_SRS_016_Kerberos_Configuration_PrincipalAndRealmSpecified("1.0"))
...
@TestScenario
@Requirements(RQ_SRS_016_Kerberos_Configuration_MultipleRealmSections("1.0"))
...
@TestScenario
@Requirements(RQ_SRS_016_Kerberos_Configuration_MultiplePrincipalSections("1.0"))
