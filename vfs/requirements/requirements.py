...
RQ_SRS_038_DiskObjectStorageVFS_Settings_Shared_SchemaInference = Requirement(
    name="RQ.SRS-038.DiskObjectStorageVFS.Settings.Shared.SchemaInference",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_038_DiskObjectStorageVFS_Settings_Shared_TTL = Requirement(
    name="RQ.SRS-038.DiskObjectStorageVFS.Settings.Shared.TTL",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_038_DiskObjectStorageVFS_Settings_Shared_S3 = Requirement(
    name="RQ.SRS-038.DiskObjectStorageVFS.Settings.Shared.S3",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_038_DiskObjectStorageVFS_Settings_Shared_ReadBackoff = Requirement(
    name="RQ.SRS-038.DiskObjectStorageVFS.Settings.Shared.ReadBackoff",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_038_DiskObjectStorageVFS_Settings_Shared_ConcurrentRead = Requirement(
    name="RQ.SRS-038.DiskObjectStorageVFS.Settings.Shared.ConcurrentRead",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
SRS_038_ClickHouse_Disk_Object_Storage_VFS = Specification(
    ...
    headings=(
        ...
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.Settings.Reload", level=3, num="4.2.9"
        ),
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.Settings.VFSToggled",
            level=3,
        ...
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.System.Delete", level=3, num="4.3.1"
        ),
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.System.ConnectionInterruption",
            level=3,
        ...
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.Table.Migration", level=3, num="4.5.3"
        ),
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.Table.TTLMove", level=3, num="4.5.4"
        ),
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.Table.TTLDelete", level=3, num="4.5.5"
        ),
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.Table.Detach", level=3, num="4.5.6"
        ),
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.Table.StoragePolicy",
            level=3,
        ...
        Heading(name="Combinatoric", level=2, num="4.6"),
        Heading(name="Supported Table Configurations", level=3, num="4.6.1"),
        Heading(name="Supported Operations", level=3, num="4.6.2"),
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.Combinatoric", level=3, num="4.6.3"
        ),
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.Combinatoric.Insert",
            level=3,
        ...
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.Performance", level=3, num="4.7.1"
        ),
        Heading(name="Object Storage Providers", level=2, num="4.8"),
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.Providers.Configuration",
            level=3,
            num="4.8.1",
        ...
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.Providers.AWS", level=3, num="4.8.2"
        ),
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.Providers.MinIO", level=3, num="4.8.3"
        ),
        Heading(
            name="RQ.SRS-038.DiskObjectStorageVFS.Providers.GCS", level=3, num="4.8.4"
        ),
    ...
    requirements=(
        ...
        RQ_SRS_038_DiskObjectStorageVFS_Settings_Shared_SchemaInference,
        RQ_SRS_038_DiskObjectStorageVFS_Settings_Shared_TTL,
        RQ_SRS_038_DiskObjectStorageVFS_Settings_Shared_S3,
        RQ_SRS_038_DiskObjectStorageVFS_Settings_Shared_ReadBackoff,
        RQ_SRS_038_DiskObjectStorageVFS_Settings_Shared_ConcurrentRead,
