...
@TestScenario
@Requirements(RQ_SRS_025_ClickHouse_DiskLevelEncryption_Disk_Encrypted("1.0"))
def encrypted_disk(self, node=None):
    """Check that ClickHouse supports disk level encryption for encrypted disk."""
        ...
        entries_in_this_test["storage_configuration"]["disks"].append(
            {
                "encrypted_local1": {
                    "type": "encrypted",
                    "disk": "encrypted_local",
                    "path": "encrypted/",
                    "key": "firstfirstfirstf",
                }
            }
        )
        entries_in_this_test["storage_configuration"]["policies"]["local_encrypted"][
            "volumes"
        ]["encrypted_disk"]["disk"] = "encrypted_local1"
