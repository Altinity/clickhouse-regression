...
def multi_chunk_upload(self):
    ...
    min_insert_block_size_rows = either([1, 1000, 10000, 100000, 1000000])
    min_insert_block_size_bytes = either([0, 1000000, 10000000, 100000000, 1000000000])
    output_format_parquet_row_group_size = either([0, 1000, 10000, 100000, 1000000])
    output_format_parquet_row_group_size_bytes = either(
        [0, 1000000, 10000000, 100000000, 1000000000]
    )
    output_format_parquet_parallel_encoding = 1
    max_threads = either([1, 2, 4, 8, 16, 32])
    max_insert_block_size = either([0, 1000000, 10000000, 100000000, 1000000000])
    max_block_size = either([0, 1000000, 10000000, 100000000, 1000000000])
