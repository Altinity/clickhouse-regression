...
SRS032_ClickHouse_Parquet_Data_Format = Specification(
    ...
    headings=(
        ...
        Heading(name="Import Nested Types", level=2, num="7.12"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Import.Nested.ArrayIntoNested",
            level=3,
            num="7.12.1",
        ...
        Heading(name="Import Chunked Columns", level=2, num="7.13"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Import.ChunkedColumns",
            level=3,
            num="7.13.1",
        ),
        Heading(name="Import Encoded", level=2, num="7.14"),
        Heading(name="Plain (Import)", level=3, num="7.14.1"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Import.Encoding.Plain",
            level=4,
            num="7.14.1.1",
        ),
        Heading(name="Dictionary (Import)", level=3, num="7.14.2"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Import.Encoding.Dictionary",
            level=4,
            num="7.14.2.1",
        ),
        Heading(name="Run Length Encoding (Import)", level=3, num="7.14.3"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Import.Encoding.RunLength",
            level=4,
            num="7.14.3.1",
        ),
        Heading(name="Delta (Import)", level=3, num="7.14.4"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Import.Encoding.Delta",
            level=4,
            num="7.14.4.1",
        ),
        Heading(name="Delta-length byte array (Import)", level=3, num="7.14.5"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Import.Encoding.DeltaLengthByteArray",
            level=4,
            num="7.14.5.1",
        ),
        Heading(name="Delta Strings (Import)", level=3, num="7.14.6"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Import.Encoding.DeltaStrings",
            level=4,
            num="7.14.6.1",
        ),
        Heading(name="Byte Stream Split (Import)", level=3, num="7.14.7"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Import.Encoding.ByteStreamSplit",
            level=4,
            num="7.14.7.1",
        ),
        Heading(name="Import Settings", level=2, num="7.15"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Import.Settings.ImportNested",
            level=3,
            num="7.15.1",
        ...
        Heading(name="Libraries", level=2, num="7.16"),
        Heading(name="RQ.SRS-032.ClickHouse.Parquet.Libraries", level=3, num="7.16.1"),
        Heading(name="Pyarrow", level=3, num="7.16.2"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Libraries.Pyarrow",
            level=4,
            num="7.16.2.1",
        ),
        Heading(name="PySpark", level=3, num="7.16.3"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Libraries.PySpark",
            level=4,
            num="7.16.3.1",
        ),
        Heading(name="Pandas", level=3, num="7.16.4"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Libraries.Pandas",
            level=4,
            num="7.16.4.1",
        ),
        Heading(name="parquet-go", level=3, num="7.16.5"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Libraries.ParquetGO",
            level=4,
            num="7.16.5.1",
        ),
        Heading(name="H2OAI", level=3, num="7.16.6"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Libraries.H2OAI",
            level=4,
            num="7.16.6.1",
        ...
        Heading(name="RQ.SRS-032.ClickHouse.Parquet.Export", level=3, num="8.16.1"),
        Heading(name="Auto Detect Parquet File When Exporting", level=3, num="8.16.2"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.Outfile.AutoDetectParquetFileFormat",
            level=4,
            num="8.16.2.1",
        ),
        Heading(name="Supported Data types", level=2, num="8.17"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.Datatypes.Supported",
            level=3,
            num="8.17.1",
        ...
        Heading(name="Working With Nested Types Export", level=2, num="8.18"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.Nested", level=3, num="8.18.1"
        ),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.Nested.Complex",
            level=3,
        ...
        Heading(name="Exporting Chunked Columns", level=2, num="8.19"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.ChunkedColumns",
            level=3,
            num="8.19.1",
        ),
        Heading(name="Query Types", level=2, num="8.20"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Export.Parquet.Join", level=3, num="8.20.1"
        ),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.Union", level=3, num="8.20.2"
        ),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.View", level=3, num="8.20.3"
        ),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.Select.MaterializedView",
            level=3,
        ...
        Heading(name="Export Encoded", level=2, num="8.21"),
        Heading(name="Plain (Export)", level=3, num="8.21.1"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.Encoding.Plain",
            level=4,
            num="8.21.1.1",
        ),
        Heading(name="Dictionary (Export)", level=3, num="8.21.2"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.Encoding.Dictionary",
            level=4,
            num="8.21.2.1",
        ),
        Heading(name="Run Length Encoding (Export)", level=3, num="8.21.3"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.Encoding.RunLength",
            level=4,
            num="8.21.3.1",
        ),
        Heading(name="Delta (Export)", level=3, num="8.21.4"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.Encoding.Delta",
            level=4,
            num="8.21.4.1",
        ),
        Heading(name="Delta-length byte array (Export)", level=3, num="8.21.5"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.Encoding.DeltaLengthByteArray",
            level=4,
            num="8.21.5.1",
        ),
        Heading(name="Delta Strings (Export)", level=3, num="8.21.6"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.Encoding.DeltaStrings",
            level=4,
            num="8.21.6.1",
        ),
        Heading(name="Byte Stream Split (Export)", level=3, num="8.21.7"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.Encoding.ByteStreamSplit",
            level=4,
            num="8.21.7.1",
        ),
        Heading(name="Export Settings", level=2, num="8.22"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.Export.Settings.RowGroupSize",
            level=3,
            num="8.22.1",
        ...
        Heading(name="Type Conversion", level=2, num="8.23"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Parquet.DataTypes.TypeConversionFunction",
            level=3,
            num="8.23.1",
