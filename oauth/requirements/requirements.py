...
SRS_042_OAuth_Authentication_in_ClickHouse = Specification(
    ...
    headings=(
        ...
        Heading(name="ClickHouse Actions After Token Validation", level=1, num="8"),
        Heading(name="Incorrect Requests to ClickHouse", level=2, num="8.1"),
        Heading(
            name="RQ.SRS-042.OAuth.Grafana.Authentication.IncorrectRequests",
            level=3,
            num="8.1.1",
        ...
        Heading(name="Token Handling", level=2, num="8.2"),
        Heading(
            name="RQ.SRS-042.OAuth.Grafana.Authentication.TokenHandling.Expired",
            level=3,
            num="8.2.1",
        ...
        Heading(name="Caching", level=2, num="8.3"),
        Heading(
            name="RQ.SRS-042.OAuth.Grafana.Authentication.Caching", level=3, num="8.3.1"
        ),
        Heading(name="Disable Caching", level=3, num="8.3.2"),
        Heading(
            name="RQ.SRS-042.OAuth.Grafana.Authentication.Caching.CacheEviction.NoCache",
            level=4,
            num="8.3.2.1",
        ),
        Heading(name="Cache Lifetime", level=3, num="8.3.3"),
        Heading(
            name="RQ.SRS-042.OAuth.Grafana.Authentication.Caching.CacheEviction.CacheLifetime",
            level=4,
            num="8.3.3.1",
        ),
        Heading(name="Exceeding Max Cache Size", level=3, num="8.3.4"),
        Heading(
            name="RQ.SRS-042.OAuth.Grafana.Authentication.Caching.CacheEviction.MaxCacheSize",
            level=4,
            num="8.3.4.1",
        ),
        Heading(name="Cache Eviction Policy", level=3, num="8.3.5"),
        Heading(
            name="RQ.SRS-042.OAuth.Grafana.Authentication.Caching.CacheEviction.Policy",
            level=4,
            num="8.3.5.1",
        ),
        Heading(name="Authentication and Login", level=2, num="8.4"),
        Heading(
            name="RQ.SRS-042.OAuth.Grafana.Authentication.Actions.Authentication",
            level=3,
            num="8.4.1",
        ...
        Heading(name="Session Management", level=2, num="8.5"),
        Heading(
            name="RQ.SRS-042.OAuth.Grafana.Authentication.Actions.SessionManagement",
            level=3,
            num="8.5.1",
