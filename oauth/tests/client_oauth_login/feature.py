...
def feature(self):
    ...
    # Feature(
    #     run=load("oauth.tests.client_oauth_login.connection_block_segfault", "feature")
    # )
    ...
    Feature(
        run=load("oauth.tests.client_oauth_login.connection_block_oauth", "feature")
    )
    Feature(run=load("oauth.tests.client_oauth_login.browser_flow", "feature"))
    Feature(run=load("oauth.tests.client_oauth_login.browser_flow_security", "feature"))
