...
def start_standalone_ch_keeper(self, control_nodes, cluster_nodes):
    ...
    if self.context.ssl == "true":
        start_standalone_keeper(
            control_nodes=control_nodes, cluster_nodes=cluster_nodes, ssl=True
        )
    else:
        start_standalone_keeper(
            control_nodes=control_nodes, cluster_nodes=cluster_nodes, ssl=False
        )
