...
# document by TestFlows v1.9.221112.1201503.
...
SRS033_ClickHouse_Key_Value_Function = Specification(
    ...
    headings=(
        ...
        Heading(
            name="RQ.SRS-033.ClickHouse.ParseKeyValue.Function", level=3, num="3.1.1"
        ),
        Heading(
            name="RQ.SRS-033.ClickHouse.ParseKeyValue.Function.SupportedDataTypes",
            level=3,
        ...
        Heading(
            name="RQ.SRS-033.ClickHouse.ParseKeyValue.Key.Format", level=3, num="3.4.1"
        ),
