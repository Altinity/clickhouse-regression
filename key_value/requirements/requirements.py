...
SRS_ClickHouse_Key_Value_Function = Specification(
    ...
    headings=(
        ...
        Heading(name='RQ.ClickHouse.ParseKeyValue.SupportedDataTypes', level=3, num='2.1.2'),
        Heading(name='RQ.ClickHouse.ParseKeyValue.UnsupportedDataTypes', level=3, num='2.1.3'),
        ),
    requirements=(
