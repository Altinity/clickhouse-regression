...
def noise_before(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        input = define("input string, that contains noise before key value pair",
                       f"'{parsed_noise} {ascii_alpha}{ascii_num}:{ascii_num}'")
        output = define("expected output", "{" + f"'{ascii_alpha}{ascii_num}':'{ascii_num}'" + "}")
...
def noise_after(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        input = define("input string, that contains noise after key value pair",
...
def noise_between(self, scenario):
    ...
    """
    with Given("I specify input, expected output and parameters"):
        input = define("input string, that contains noise between key value pair",
...
def properly_defined_key(self, scenario):
    ...
    """
    with Given("I specify input, expected output and parameters"):
        input = define("input string, that contains properly defined key",
...
def key_first_symbol(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        input = define("input string with key, that starts with number",
...
def key_symbols(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        input = define("input string with key, that contains punctuation marks",
...
def properly_defined_value(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        input = define("input string, that contains properly defined value",
...
def value_symbols(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        input = define("input string with value that contains punctuation marks",
...
@TestCheck
@Requirements(RQ_SRS_033_ClickHouse_ExtractKeyValuePairs_ParametersSpecifying_ValueSpecialCharactersAllowList("1.0"))
def specifying_value_special_characters_allow_list(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        input = define("input string, that contains symbols from value_special_characters_allow_list",
                       f"'{ascii_alpha}:.{ascii_alpha}.]['")
        output = define("expected output", "{" + f"'{ascii_alpha}':'.{ascii_alpha}.]['" + "}")
...
@TestCheck
@Requirements(RQ_SRS_033_ClickHouse_ExtractKeyValuePairs_ParametersSpecifying_EnclosingCharacter("1.0"))
def specifying_enclosing_character_non_alpha(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        input = define("input string, that contains `-`",
                       f"'{ascii_alpha}:-{ascii_alpha}{parsed_noise.replace('-', '')}-'")
        output = define("expected output", "{" + f"'{ascii_alpha}':'{ascii_alpha}{noise.replace('-', '')}" + "}")
        params = define("function parameters with enclosing character as `-`", "'\\\\', ':', ',', '-'")
...
def specifying_enclosing_character_alpha(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        input = define("input string, that contains `q`", f"'{ascii_alpha}:q{parsed_noise}q'")
        output = define("expected output", "{" + f"'{ascii_alpha}':'{parsed_noise}" + "}")
        params = define("function parameters with enclosing character as `q`","'\\\\', ':', ',', 'q'")

    scenario(input=input, output=output, params=params)


@TestCheck
@Requirements(RQ_SRS_033_ClickHouse_ExtractKeyValuePairs_ParametersSpecifying_ItemDelimiter("1.0"))
...
def specifying_item_delimiter_alpha(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        input = define("input string, that contains `q`", f"'{ascii_alpha.replace('q', '')}:" \
                f"{ascii_num}q{ascii_alpha.replace('q', '')}{ascii_num}:{ascii_num}'")
        output = define("expected output", "{" + f"'{ascii_alpha.replace('q', '')}':" \
...
@TestCheck
@Requirements(RQ_SRS_033_ClickHouse_ExtractKeyValuePairs_ParametersSpecifying_KeyValuePairDelimiter("1.0"))
def specifying_key_value_pair_delimiter_non_alpha(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        input = define("input string, that contains `-`", f"'{ascii_alpha}-{ascii_alpha}'")
        output = define("expected output", "{" + f"'{ascii_alpha}':'{ascii_alpha}'" + "}")
        params = define("function parameters with key value pair delimiter as `-`", "'\\\\', '-'")
...
def specifying_key_value_pair_delimiter_alpha(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        input = define("input string, that contains `q`", f"'{ascii_alpha.replace('q', '')}q{ascii_num}'")
        output = define("expected output", "{" + f"'{ascii_alpha.replace('q', '')}':'{ascii_num}'" + "}")
        params = define("function parameters with key value pair delimiter as `q`", "'\\\\', 'q'")

    scenario(input=input, output=output, params=params)


@TestCheck
@Requirements(RQ_SRS_033_ClickHouse_ExtractKeyValuePairs_ParametersSpecifying_EscapeCharacter("1.0"))
...
def specifying_escape_character_alpha(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        input = define("input string, that contains `q`", f"'{ascii_alpha.replace('q', '')},q)'")
        output = define("expected output", "{" + f"'{ascii_alpha.replace('q', '')}':')'" + "}")
...
@Requirements(RQ_SRS_033_ClickHouse_ExtractKeyValuePairs_Default_ValueSpecialCharactersAllowList("1.0"))
def value_special_characters_allow_list_default_value(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        input = define("input string that contains all ascii symbols", f"'{ascii_alpha}:{parsed_noise}{ascii_num}'")
        output = define("expected output", "{" + f"'{ascii_alpha}':''" + "}")
...
@Requirements(RQ_SRS_033_ClickHouse_ExtractKeyValuePairs_Default_EnclosingCharacter("1.0"))
def enclosing_character_default_value(self, scenario):
    ...
    with Given("I specify input, expected output and parameters"):
        ...
        output = define("expected output", "{" + f"'{ascii_alpha}':'{noise_without_quotation_mark}{ascii_num}'" + "}")
        params = define("function parameters", "")
...
@Requirements(RQ_SRS_033_ClickHouse_ExtractKeyValuePairs_Default_KeyValuePairDelimiter("1.0"))
...
def input_format(self, scenario):
    ...
    with When("I specify input string using string that contains all ascii symbols"):
        input = define("input string that contains all ascii symbols", f"'{ascii_alpha}{ascii_num}{parsed_noise}'")
        output = define("expected output", "{}")
        params = define("function parameters", f"'\\\\\\\\', ':', ',', '\\\"'")
...
checks = [noise_checks, key_format_checks, value_format_checks, default_parameters_values_checks,
          input_format_checks, custom_special_symbols_checks]