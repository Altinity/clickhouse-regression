...
def scenario(self, engine):
    ...
    table_name = "table_minmove_" + engine.split("(")[0].lower()
    ...
    try:
        ...
        with When("poll maximum 20 times to check used disks for the table"):
        ...
        with And("path_on_disk for all parts should have path to the jbod1"):
            for p in path:
