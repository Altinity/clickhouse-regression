...
def empty_user_name(self, timeout=300):
    ...
    users = [
        {"server": "openldap1", "username": "", "password": "user1", "login": True}
    ]
...
@TestScenario
@Requirements(RQ_SRS_007_LDAP_Configuration_User_Syntax("1.0"))
...
@TestScenario
@Requirements(RQ_SRS_007_LDAP_Configuration_User_OnlyOneServer("1.0"))
...
@TestScenario
@Requirements(RQ_SRS_007_LDAP_Configuration_User_BothPasswordAndLDAP("1.0"))
