...
@TestScenario
@Requirements(RQ_SRS_007_LDAP_Server_Configuration_Invalid("1.0"))
...
def invalid_auth_dn_suffix(self):
    ...
    servers = {
        "openldap1": {
            ...
            "enable_tls": "no",
            "auth_dn_prefix": "cn=",
            "auth_dn_suffix": ",foo=users,dc=company,dc=com",
        }
    }
    users = [
        {
...
@Examples(
    ...
    [
        ...
        (
            ...
            Name("overflow with extremely large negative int value"),
        ),
        ("@#", Name("special characters")),
    ],
)
@Requirements(RQ_SRS_007_LDAP_Configuration_Server_VerificationCooldown_Invalid("1.0"))
...
@TestScenario
@Requirements(RQ_SRS_007_LDAP_Configuration_Server_Syntax("2.0"))
def syntax(self):
