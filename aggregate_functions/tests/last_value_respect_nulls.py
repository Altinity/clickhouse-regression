...
@Requirements(RQ_SRS_031_ClickHouse_AggregateFunctions_Miscellaneous_LastValueRespectNulls("1.0"))
def scenario(self, func="last_value_respect_nulls({params})", table=None, snapshot_id=None):
