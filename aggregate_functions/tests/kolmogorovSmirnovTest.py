...
@Requirements(RQ_SRS_031_ClickHouse_AggregateFunctions_Specific_KolmogorovSmirnovTest("1.0"))
def scenario(self, func="kolmogorovSmirnovTest({params})", table=None, snapshot_id=None):
