...
def scenario(self, func="maxMappedArrays({params})", table=None, snapshot_id=None):
    """Check maxMap(maxMappedArrays) aggregate function by using the same tests as for sumMap."""
