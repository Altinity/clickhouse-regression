...
@Requirements(RQ_SRS_031_ClickHouse_AggregateFunctions_Specific_ExponentialMovingAverage("1.0"))
def feature(self, func="exponentialMovingAverage(0.5)({params})", table=None):
