...
def check_cascade_mv_definer_mv_definer_mv(self):
    ...
    with Pool(7) as executor:
        for (
            ...
            test_name = f"user-{user_source_privileges},user_target_two_privileges-{user_target_two_privileges},definer_one_source-{definer_one_source_privileges},definer_one_target_one-{definer_one_target_one_privileges},definer_two_target_one-{definer_two_target_one_privileges},definer_two_target_two-{definer_two_target_two_privileges},grant_privileges_option-{grant_privilege.__name__}"
            test_name = (
                test_name.replace("(", "_")
                .replace(")", "_")
                .replace(" ", "")
