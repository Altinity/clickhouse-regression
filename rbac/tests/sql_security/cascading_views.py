...
def check_cascade_mv_definer_mv_definer_mv_definer(self):
    ...
    with And(
        """I use covering array with strength 6 to decrease the number of combinations.
    ...
    with And(
        "I create a list of lists of privileges from the covering array with some combinations of privileges"
    ):
...
def check_cascade_mv_mv_definer_mv_definer(self):
    ...
    with And(
        """I use covering array with strength 4 to decrease the number of combinations.
        The strength of a covering array specifies the number of variables for which 
        all possible value combinations must appear at least once in the array."""
    ):
    ...
    with And(
        "I create a list of lists from covering array with some combinations of privileges"
    ):
        privileges_combinations = [
            [
                item["user_source_privileges"],
    ...
    with Pool(7) as executor:
        for (
            ...
            test_name = f"user-{user_source_privileges},definer_two_target_one-{definer_two_target_one_privileges},definer_two_target_two-{definer_two_target_two_privileges},definer_three_target_two-{definer_three_target_two_privileges},definer_three_target_three-{definer_three_target_three_privileges},grant_privileges_option-{grant_privilege.__name__}"
            test_name = (
                test_name.replace("(", "_")
                .replace(")", "_")
                .replace(" ", "")
...
def check_cascade_mv_mv_mv_definer(self):
    ...
    with Pool(7) as executor:
        for (
            ...
            test_name = f"user-{user_source_privileges},user_target_one-{user_target_one_privileges},definer_three_target_two-{definer_three_target_two_privileges},definer_three_target_three-{definer_three_target_three_privileges},grant_privileges_option-{grant_privilege.__name__}"
            test_name = (
                test_name.replace("(", "_")
                .replace(")", "_")
                .replace(" ", "")
...
def check_cascade_mv_mv_definer_mv(self):
    ...
    with Pool(7) as executor:
        for (
            ...
            test_name = f"user-{user_source_privileges},user_target_two-{user_target_two_privileges},definer_two_target_one-{definer_two_target_one_privileges},definer_two_target_two-{definer_two_target_two_privileges},grant_privileges_option-{grant_privilege.__name__}"
            test_name = (
                test_name.replace("(", "_")
                .replace(")", "_")
                .replace(" ", "")
