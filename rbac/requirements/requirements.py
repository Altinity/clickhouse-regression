...
RQ_SRS_006_RBAC_RowPolicy_Parts = Requirement(
    name="RQ.SRS-006.RBAC.RowPolicy.Parts",
    version="1.0",
    priority=None,
    group=None,
    type=None,
    uid=None,
    description=(
        "[ClickHouse] SHALL correctly apply row policy filtering regardless of how many parts the data was inserted into.\n"
        "\n"
    ),
    link=None,
    level=3,
...
RQ_SRS_006_RBAC_RowPolicy_Columns = Requirement(
    name="RQ.SRS-006.RBAC.RowPolicy.Columns",
    version="1.0",
    priority=None,
    group=None,
    type=None,
    uid=None,
    description=(
        "[ClickHouse] SHALL correctly apply row policy filtering regardless of how many columns are in the SELECT query.\n"
        "\n"
    ),
    link=None,
    level=3,
...
RQ_SRS_006_RBAC_RowPolicy_MultiIf = Requirement(
    name="RQ.SRS-006.RBAC.RowPolicy.MultiIf",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_006_RBAC_RowPolicy_MultiIfLength = Requirement(
    name="RQ.SRS-006.RBAC.RowPolicy.MultiIfLength",
    version="1.0",
    priority=None,
    group=None,
    type=None,
    uid=None,
    description=(
        "[ClickHouse] SHALL correctly apply row policy filtering regardless of the length of multiIf arguments.\n"
        "\n"
    ),
    link=None,
    level=3,
...
RQ_SRS_006_RBAC_RowPolicy_Rows = Requirement(
    name="RQ.SRS-006.RBAC.RowPolicy.Rows",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_006_RBAC_RowPolicy_Dictionary = Requirement(
    name="RQ.SRS-006.RBAC.RowPolicy.Dictionary",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_006_RBAC_RowPolicy_MaterializedView = Requirement(
    name="RQ.SRS-006.RBAC.RowPolicy.MaterializedView",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_006_RBAC_RowPolicy_DistributedTable = Requirement(
    name="RQ.SRS-006.RBAC.RowPolicy.DistributedTable",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_006_RBAC_RowPolicy_Copy = Requirement(
    name="RQ.SRS-006.RBAC.RowPolicy.Copy",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_006_RBAC_RowPolicy_Rename = Requirement(
    name="RQ.SRS-006.RBAC.RowPolicy.Rename",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_006_RBAC_RowPolicy_Window = Requirement(
    name="RQ.SRS-006.RBAC.RowPolicy.Window",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_006_RBAC_RowPolicy_Neighbor = Requirement(
    name="RQ.SRS-006.RBAC.RowPolicy.Neighbor",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_006_RBAC_RowPolicy_Partitions = Requirement(
    name="RQ.SRS-006.RBAC.RowPolicy.Partitions",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_006_RBAC_SQLSecurity_ModifySQLSecurity = Requirement(
...
RQ_SRS_006_RBAC_SQLSecurity_MaterializedView_Select_SqlSecurityDefiner_Definer = Requirement(
    ...
    description=(
        ...
        "| `DEFINER`    | `alice` | `SELECT`          |\n"
        "\n"
        "[ClickHouse] SHALL only succesfully `SELECT` from a materialized view with described SQL security options if and only if the user has `SELECT` privilege for the view and definer user (alice) has **`SELECT`** privilege for the materialized view's **source and target** tables.\n"
        "\n"
    ),
    link=None,
    level=4,
...
RQ_SRS_006_RBAC_SQLSecurity_MaterializedView_Insert_SqlSecurityDefiner_Definer = Requirement(
    ...
    description=(
        ...
        "\n"
        "[ClickHouse] SHALL only succesfully `INSERT` into a materialized view with described SQL security options if and only if the user has `INSERT` privilege for the view and definer user (alice) has **`INSERT`** privilege for the materialized view's **target** table.\n"
        "\n"
        "\n"
    ),
    link=None,
...
RQ_SRS_006_RBAC_SQLSecurity_MaterializedView_Insert_SqlSecurityDefiner_DefinerNotSpecified = Requirement(
    ...
    description=(
        ...
        "\n"
        "[ClickHouse] SHALL automatically set `DEFINER` to `CURRENT_USER` if `DEFINER` is not specified and `SQL SECURITY` `DEFINER` is specified. [ClickHouse] SHALL only succesfully `INSERT` into a materialized view with described SQL security options if and only if the user has `INSERT` privilege for the view and definer user has **`INSERT`** privilege for the materialized view's **target** table.\n"
        "\n"
    ),
    link=None,
    level=4,
...
RQ_SRS_006_RBAC_SQLSecurity_MaterializedView_Insert_SqlSecurityNotSpecified_Definer = Requirement(
    ...
    description=(
        ...
        "\n"
        "[ClickHouse] SHALL automatically set `SQL SECURITY` to `DEFINER` if `SQL SECURITY` is not specified and `DEFINER` is specified. [ClickHouse] SHALL only succesfully `INSERT` into a materialized view with described SQL security options if and only if the user has `INSERT` privilege for the view and definer user (alice) has **`INSERT`** privilege for the materialized view's **target** table.\n"
        "\n"
    ),
    link=None,
    level=4,
...
SRS_006_ClickHouse_Role_Based_Access_Control = Specification(
    ...
    headings=(
        ...
        Heading(name="Feature Diagram", level=3, num="5.8.1"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy", level=3, num="5.8.2"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Condition", level=3, num="5.8.3"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Restriction", level=3, num="5.8.4"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Nesting", level=3, num="5.8.5"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Parts", level=3, num="5.8.6"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Columns", level=3, num="5.8.7"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.MultiIf", level=3, num="5.8.8"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.MultiIfLength", level=3, num="5.8.9"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Rows", level=3, num="5.8.10"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Dictionary", level=3, num="5.8.11"),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.MaterializedView", level=3, num="5.8.12"
        ),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.DistributedTable", level=3, num="5.8.13"
        ),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Copy", level=3, num="5.8.14"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Rename", level=3, num="5.8.15"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Window", level=3, num="5.8.16"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Neighbor", level=3, num="5.8.17"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Partitions", level=3, num="5.8.18"),
        Heading(name="Create Row Policy", level=3, num="5.8.19"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Create", level=4, num="5.8.19.1"),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Create.IfNotExists", level=4, num="5.8.19.2"
        ),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Create.Replace", level=4, num="5.8.19.3"
        ),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Create.OnCluster", level=4, num="5.8.19.4"
        ),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Create.On", level=4, num="5.8.19.5"),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Create.Access", level=4, num="5.8.19.6"
        ),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Create.Access.Permissive",
            level=4,
        ...
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Create.ForSelect", level=4, num="5.8.19.9"
        ),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Create.Condition", level=4, num="5.8.19.10"
        ),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Create.Assignment", level=4, num="5.8.19.11"
        ),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Create.Assignment.None",
            level=4,
        ...
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Create.Syntax", level=4, num="5.8.19.15"
        ),
        Heading(name="Alter Row Policy", level=3, num="5.8.20"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Alter", level=4, num="5.8.20.1"),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Alter.IfExists", level=4, num="5.8.20.2"
        ),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Alter.ForSelect", level=4, num="5.8.20.3"
        ),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Alter.OnCluster", level=4, num="5.8.20.4"
        ),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Alter.On", level=4, num="5.8.20.5"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Alter.Rename", level=4, num="5.8.20.6"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Alter.Access", level=4, num="5.8.20.7"),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Alter.Access.Permissive",
            level=4,
            num="5.8.20.8",
        ...
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Alter.Condition", level=4, num="5.8.20.10"
        ),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Alter.Condition.None",
            level=4,
        ...
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Alter.Assignment", level=4, num="5.8.20.12"
        ),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Alter.Assignment.None",
            level=4,
        ...
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Alter.Syntax", level=4, num="5.8.20.16"
        ),
        Heading(name="Drop Row Policy", level=3, num="5.8.21"),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Drop", level=4, num="5.8.21.1"),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Drop.IfExists", level=4, num="5.8.21.2"
        ),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Drop.On", level=4, num="5.8.21.3"),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.Drop.OnCluster", level=4, num="5.8.21.4"
        ),
        Heading(name="RQ.SRS-006.RBAC.RowPolicy.Drop.Syntax", level=4, num="5.8.21.5"),
        Heading(name="Show Create Row Policy", level=3, num="5.8.22"),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.ShowCreateRowPolicy",
            level=4,
            num="5.8.22.1",
        ...
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.ShowRowPolicies", level=4, num="5.8.22.4"
        ),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.ShowRowPolicies.On", level=4, num="5.8.22.5"
        ),
        Heading(
            name="RQ.SRS-006.RBAC.RowPolicy.ShowRowPolicies.Syntax",
            level=4,
    ...
    requirements=(
        ...
        RQ_SRS_006_RBAC_RowPolicy_Parts,
        RQ_SRS_006_RBAC_RowPolicy_Columns,
        RQ_SRS_006_RBAC_RowPolicy_MultiIf,
        RQ_SRS_006_RBAC_RowPolicy_MultiIfLength,
        RQ_SRS_006_RBAC_RowPolicy_Rows,
        RQ_SRS_006_RBAC_RowPolicy_Dictionary,
        RQ_SRS_006_RBAC_RowPolicy_MaterializedView,
        RQ_SRS_006_RBAC_RowPolicy_DistributedTable,
        RQ_SRS_006_RBAC_RowPolicy_Copy,
        RQ_SRS_006_RBAC_RowPolicy_Rename,
        RQ_SRS_006_RBAC_RowPolicy_Window,
        RQ_SRS_006_RBAC_RowPolicy_Neighbor,
        RQ_SRS_006_RBAC_RowPolicy_Partitions,
...
* 5 [Requirements](#requirements)
    ...
    * 5.18 [Views](#views)
        ...
        * 5.18.4 [View SQL Security](#view-sql-security)
            ...
            * 5.18.4.4 [RQ.SRS-006.RBAC.SQLSecurity.View.Select.SqlSecurityDefiner.Definer](#rqsrs-006rbacsqlsecurityviewselectsqlsecuritydefinerdefiner)
            * 5.18.4.5 [RQ.SRS-006.RBAC.SQLSecurity.View.Select.SqlSecurityDefiner.DefinerNotSpecified](#rqsrs-006rbacsqlsecurityviewselectsqlsecuritydefinerdefinernotspecified)
            * 5.18.4.6 [RQ.SRS-006.RBAC.SQLSecurity.View.Select.SqlSecurityInvoker.Definer](#rqsrs-006rbacsqlsecurityviewselectsqlsecurityinvokerdefiner)
            * 5.18.4.7 [RQ.SRS-006.RBAC.SQLSecurity.View.Select.SqlSecurityInvoker.DefinerNotSpecified](#rqsrs-006rbacsqlsecurityviewselectsqlsecurityinvokerdefinernotspecified)
            * 5.18.4.8 [RQ.SRS-006.RBAC.SQLSecurity.View.Select.SqlSecurityNotSpecified.Definer](#rqsrs-006rbacsqlsecurityviewselectsqlsecuritynotspecifieddefiner)
            * 5.18.4.9 [RQ.SRS-006.RBAC.SQLSecurity.View.Select.SqlSecurityDefinerNotSpecified.DefinerNotSpecified](#rqsrs-006rbacsqlsecurityviewselectsqlsecuritydefinernotspecifieddefinernotspecified)
            * 5.18.4.10 [RQ.SRS-006.RBAC.SQLSecurity.View.Select.SqlSecurityNone.Definer](#rqsrs-006rbacsqlsecurityviewselectsqlsecuritynonedefiner)
            * 5.18.4.11 [RQ.SRS-006.RBAC.SQLSecurity.View.Select.SqlSecurityNone.DefinerNotSpecified](#rqsrs-006rbacsqlsecurityviewselectsqlsecuritynonedefinernotspecified)
...
#### RQ.SRS-006.RBAC.RowPolicy.Parts
version: 1.0

[ClickHouse] SHALL correctly apply row policy filtering regardless of how many parts the data was inserted into.

#### RQ.SRS-006.RBAC.RowPolicy.Columns
version: 1.0
...
#### RQ.SRS-006.RBAC.RowPolicy.Rows
version: 1.0
...
| --------------------|------|-------------------|
| `DEFINER alice` | `alice` must have a `SELECT` grant for the view's source table.	 | `alice` must have a `SELECT` grant for the view's source table and an `SELECT` grant for the view's target table. |
