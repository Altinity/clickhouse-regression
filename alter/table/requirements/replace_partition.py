...
RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionTemporaryTables = Requirement(
    name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionTemporaryTables",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionDisks = Requirement(
    name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionDisks",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionS3 = Requirement(
    name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionS3",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionReplicas = Requirement(
    name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionReplicas",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionShards = Requirement(
    name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionShards",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionVersions = Requirement(
    name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionVersions",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionEncodings = Requirement(
    name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionEncodings",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionEncryption = Requirement(
    name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionEncryption",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionDeduplication = Requirement(
    name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionDeduplication",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartition_RBAC = Requirement(
    ...
    uid=None,
    description=(
        "[ClickHouse] SHALL output an error when a specific user without `ALTER TABLE` privileges tries to execute query with `REPLACE PARTITION`.\n"
        "\n"
        "\n"
    ),
    link=None,
...
SRS032_ClickHouse_Alter_Table_Replace_Partition = Specification(
    ...
    headings=(
        ...
        Heading(name="Replacing Partitions Form Temporary Table", level=1, num="11"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.TemporaryTable",
            level=2,
            num="11.1",
        ...
        Heading(
            name="Rules For Replacing Partitions Between Tables", level=2, num="25.1"
        ),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Conditions",
            level=3,
        ...
        Heading(name="Replacing Partitions With Table Functions", level=2, num="26.4"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.TableFunctions",
            level=3,
            num="26.4.1",
        ),
        Heading(name="Replacing Partitions With Subquery", level=2, num="26.5"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.Subquery",
            level=3,
            num="26.5.1",
        ),
        Heading(name="Replacing Partitions With Join Clause", level=2, num="26.6"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.Join",
            level=3,
            num="26.6.1",
        ...
        Heading(name="Insert Into Table", level=2, num="27.2"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Insert",
            level=3,
            num="27.2.1",
        ),
        Heading(name="Delete Table", level=2, num="27.3"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Delete",
            level=3,
            num="27.3.1",
        ),
        Heading(name="Attach Table", level=2, num="27.4"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Attach",
            level=3,
            num="27.4.1",
        ),
        Heading(name="Detach Table", level=2, num="27.5"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Detach",
            level=3,
            num="27.5.1",
        ),
        Heading(name="Optimize Table", level=2, num="27.6"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Optimize",
            level=3,
            num="27.6.1",
        ),
        Heading(name="Alter", level=2, num="27.7"),
        Heading(name="Add Column", level=3, num="27.7.1"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.Add",
            level=4,
            num="27.7.1.1",
        ),
        Heading(name="Drop Column", level=3, num="27.7.2"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.Drop",
            level=4,
            num="27.7.2.1",
        ),
        Heading(name="Clear Column", level=3, num="27.7.3"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.Clear",
            level=4,
            num="27.7.3.1",
        ),
        Heading(name="Modify Column", level=3, num="27.7.4"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.Modify",
            level=4,
            num="27.7.4.1",
        ),
        Heading(name="Modify Column Remove", level=3, num="27.7.5"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.ModifyRemove",
            level=4,
            num="27.7.5.1",
        ),
        Heading(name="Materialize", level=3, num="27.7.6"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.Materialize",
            level=4,
            num="27.7.6.1",
        ),
        Heading(name="Manipulating Partitions", level=2, num="27.8"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions",
            level=3,
            num="27.8.1",
        ),
        Heading(name="Detach", level=3, num="27.8.2"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions.Detach",
            level=4,
            num="27.8.2.1",
        ),
        Heading(name="Drop", level=3, num="27.8.3"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions.Drop",
            level=4,
            num="27.8.3.1",
        ),
        Heading(name="Attach", level=3, num="27.8.4"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions.Attach",
            level=4,
            num="27.8.4.1",
        ),
        Heading(name="Attach From", level=3, num="27.8.5"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions.AttachFrom",
            level=4,
            num="27.8.5.1",
        ),
        Heading(name="Replace", level=3, num="27.8.6"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions.Replace",
            level=4,
            num="27.8.6.1",
        ),
        Heading(name="Move To Table", level=3, num="27.8.7"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions.MoveToTable",
            level=4,
            num="27.8.7.1",
        ),
        Heading(name="Clear Column In Partition", level=3, num="27.8.8"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions.ClearColumnInPartition",
            level=4,
            num="27.8.8.1",
        ),
        Heading(name="Freeze", level=3, num="27.8.9"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions.Freeze",
            level=4,
            num="27.8.9.1",
        ),
        Heading(name="Unfreeze", level=3, num="27.8.10"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions.Unfreeze",
            level=4,
            num="27.8.10.1",
        ),
        Heading(name="Clear Index", level=3, num="27.8.11"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions.ClearIndex",
            level=4,
            num="27.8.11.1",
        ),
        Heading(name="Fetch", level=3, num="27.8.12"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions.Fetch",
            level=4,
            num="27.8.12.1",
        ),
        Heading(name="Move", level=3, num="27.8.13"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions.Move",
            level=4,
            num="27.8.13.1",
        ),
        Heading(name="Update In", level=3, num="27.8.14"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions.UpdateInPartition",
            level=4,
            num="27.8.14.1",
        ),
        Heading(name="Delete In", level=3, num="27.8.15"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Manipulating.Partitions.DeleteInPartition",
            level=4,
            num="27.8.15.1",
        ...
        Heading(
            name="Replacing Partition Without Alter Privileges  ", level=2, num="28.1"
        ),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.RBAC",
            level=3,
    ...
    requirements=(
        ...
        RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionTemporaryTables,
        ...
        RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionDisks,
        RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionS3,
        RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionReplicas,
        RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionShards,
        RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartitionVersions,
...
* 10 [Replacing Partitions Form Temporary Table](#replacing-partitions-form-temporary-table)
...
* 11 [Replacing Partitions Between Temporary Tables](#replacing-partitions-between-temporary-tables)
    * 11.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionTemporaryTables](#rqsrs-032clickhousealtertablereplacepartitiontemporarytables)
...
* 15 [Replacing Partitions From One Disk To Another In The Same Table](#replacing-partitions-from-one-disk-to-another-in-the-same-table)
    * 15.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionDisks](#rqsrs-032clickhousealtertablereplacepartitiondisks)
* 16 [Replacing Partitions Between Tables On S3](#replacing-partitions-between-tables-on-s3)
    * 16.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionS3](#rqsrs-032clickhousealtertablereplacepartitions3)
* 17 [Replacing Partitions Between Replicas](#replacing-partitions-between-replicas)
    * 17.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionReplicas](#rqsrs-032clickhousealtertablereplacepartitionreplicas)
* 18 [Replacing Partitions Between Shards](#replacing-partitions-between-shards)
    * 18.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionShards](#rqsrs-032clickhousealtertablereplacepartitionshards)
* 19 [Replacing Partitions Between Different ClickHouse versions](#replacing-partitions-between-different-clickhouse-versions)
    * 19.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionVersions](#rqsrs-032clickhousealtertablereplacepartitionversions)
* 20 [Replacing Partitions Between Different Encodings](#replacing-partitions-between-different-encodings)
    * 20.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionEncodings](#rqsrs-032clickhousealtertablereplacepartitionencodings)
* 21 [Replacing Partitions Between Encrypted And Unencrypted Tables](#replacing-partitions-between-encrypted-and-unencrypted-tables)
    * 21.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionEncryption](#rqsrs-032clickhousealtertablereplacepartitionencryption)
...
* 27 [Role Based Access Control](#role-based-access-control)
    * 27.1 [Replacing Partition Without Alter Privileges  ](#replacing-partition-without-alter-privileges-)
        * 27.1.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.RBAC](#rqsrs-032clickhousealtertablereplacepartitionrbac)
    * 27.2 [Replacing Partition Without Read Access To The Table](#replacing-partition-without-read-access-to-the-table)
        * 27.2.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.RBAC.ReadTable](#rqsrs-032clickhousealtertablereplacepartitionrbacreadtable)
...
### RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionTemporaryTables
version: 1.0
...
### RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionDisks
version: 1.0
...
### RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionS3
version: 1.0
...
### RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionReplicas
version: 1.0
...
### RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionShards
version: 1.0
...
### RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionVersions
version: 1.0
...
### RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionEncodings
version: 1.0
...
### RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionEncryption
version: 1.0
...
### RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartitionDeduplication
version: 1.0
