...
RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartition_Supported_Engines = Requirement(
...
RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartition_ToTemporaryTable = Requirement(
    name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.ToTemporaryTable",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartition_FromRegularTable = Requirement(
    name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.FromRegularTable",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartition_Prohibited_From_RemoteTable = Requirement(
    name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.From.RemoteTable",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
SRS032_ClickHouse_Alter_Table_Replace_Partition = Specification(
    ...
    headings=(
        ...
        Heading(
            name="What Is the Difference Between Attach Partition and Replace Partition",
            level=1,
            num="7",
        ),
        Heading(
            name="Replace Partition on the Table From Another Table", level=1, num="8"
        ),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition",
            level=2,
        ...
        Heading(name="Table With Non-Existent Partition", level=1, num="11"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.NonExistentPartition",
            level=2,
            num="11.1",
        ),
        Heading(name="Temporary Tables", level=1, num="12"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.TemporaryTable",
            level=2,
            num="12.1",
        ),
        Heading(name="From Temporary Table", level=2, num="12.2"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.FromTemporaryTable",
            level=3,
            num="12.2.1",
        ),
        Heading(name="From Temporary Table To Temporary Table", level=2, num="12.3"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.ToTemporaryTable",
            level=3,
            num="12.3.1",
        ),
        Heading(name="From Regular Table To Temporary Table", level=2, num="12.4"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.FromRegularTable",
            level=3,
            num="12.4.1",
        ...
        Heading(name="Table That Is Stored on Tiered Storage", level=1, num="18"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.TieredStorage",
            level=2,
            num="18.1",
        ...
        Heading(
            name="Destination Table That Is on a Different Replica", level=1, num="19"
        ),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Replicas",
            level=2,
        ...
        Heading(
            name="Destination Table That Is on a Different Shard", level=1, num="20"
        ),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Shards",
            level=2,
        ...
        Heading(
            name="Actions That Can Not Be Used After From Clause", level=2, num="26.2"
        ),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.From",
            level=3,
        ...
        Heading(name="Table Functions", level=3, num="26.2.3"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.From.TableFunctions",
            level=4,
            num="26.2.3.1",
        ),
        Heading(name="Subquery", level=3, num="26.2.4"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.Subquery",
            level=4,
            num="26.2.4.1",
        ),
        Heading(name="Join Clause", level=3, num="26.2.5"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.Join",
            level=4,
            num="26.2.5.1",
        ...
        Heading(name="View", level=3, num="26.2.7"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.View.Normal",
            level=4,
            num="26.2.7.1",
        ),
        Heading(name="Materialized View", level=3, num="26.2.8"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.View.Materialized",
            level=4,
            num="26.2.8.1",
        ),
        Heading(name="Using Order By and Partition By", level=2, num="26.3"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.OrderAndPartition",
            level=3,
            num="26.3.1",
        ...
        Heading(name="Modify Column", level=3, num="27.9.3"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.Modify",
            level=4,
            num="27.9.3.1",
        ),
        Heading(name="Rename Column", level=3, num="27.9.4"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.RenameColumn",
            level=4,
            num="27.9.4.1",
        ),
        Heading(name="Comment Column", level=3, num="27.9.5"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.CommentColumn",
            level=4,
            num="27.9.5.1",
        ),
        Heading(name="Add Constraint", level=3, num="27.9.6"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.AddConstraint",
            level=4,
            num="27.9.6.1",
    ...
    requirements=(
        ...
        RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartition_Supported_Engines,
        ...
        RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartition_ToTemporaryTable,
        RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartition_FromRegularTable,
        ...
        RQ_SRS_032_ClickHouse_Alter_Table_ReplacePartition_Prohibited_From,
...
* 7 [Replace Partition on the Table From Another Table](#replace-partition-on-the-table-from-another-table)
    ...
    * 7.2 [Reflect Changes in Table Partitions Inside the System Table](#reflect-changes-in-table-partitions-inside-the-system-table)
        * 7.2.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.System.Parts](#rqsrs-032clickhousealtertablereplacepartitionsystemparts)
* 8 [Table Engines on Which Replace Partition Can Be Performed](#table-engines-on-which-replace-partition-can-be-performed)
    * 8.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Supported.Engines](#rqsrs-032clickhousealtertablereplacepartitionsupportedengines)
* 9 [Keeping Data on the Source Table After Replace Partition](#keeping-data-on-the-source-table-after-replace-partition)
    * 9.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.KeepData](#rqsrs-032clickhousealtertablereplacepartitionkeepdata)
* 10 [Table With Non-Existent Partition](#table-with-non-existent-partition)
    * 10.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.NonExistentPartition](#rqsrs-032clickhousealtertablereplacepartitionnonexistentpartition)
* 11 [Temporary Tables](#temporary-tables)
    * 11.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.TemporaryTable](#rqsrs-032clickhousealtertablereplacepartitiontemporarytable)
    * 11.2 [From Temporary Table](#from-temporary-table)
        * 11.2.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.FromTemporaryTable](#rqsrs-032clickhousealtertablereplacepartitionfromtemporarytable)
    * 11.3 [From Temporary Table To Temporary Table](#from-temporary-table-to-temporary-table)
        * 11.3.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.ToTemporaryTable](#rqsrs-032clickhousealtertablereplacepartitiontotemporarytable)
    * 11.4 [From Regular Table To Temporary Table](#from-regular-table-to-temporary-table)
        * 11.4.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.FromRegularTable](#rqsrs-032clickhousealtertablereplacepartitionfromregulartable)
...
* 17 [Table That Is Stored on Tiered Storage](#table-that-is-stored-on-tiered-storage)
    * 17.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.TieredStorage](#rqsrs-032clickhousealtertablereplacepartitiontieredstorage)
* 18 [Destination Table That Is on a Different Replica](#destination-table-that-is-on-a-different-replica)
    * 18.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Replicas](#rqsrs-032clickhousealtertablereplacepartitionreplicas)
* 19 [Destination Table That Is on a Different Shard](#destination-table-that-is-on-a-different-shard)
    * 19.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Shards](#rqsrs-032clickhousealtertablereplacepartitionshards)
* 20 [Table That Is Stored on a Server With Different ClickHouse Version](#table-that-is-stored-on-a-server-with-different-clickhouse-version)
    * 20.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Versions](#rqsrs-032clickhousealtertablereplacepartitionversions)
...
* 25 [Actions That Can Not Be Used Along Replace Partition Operation](#actions-that-can-not-be-used-along-replace-partition-operation)
    ...
    * 25.2 [Actions That Can Not Be Used After From Clause](#actions-that-can-not-be-used-after-from-clause)
        * 25.2.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.From](#rqsrs-032clickhousealtertablereplacepartitionprohibitedfrom)
        * 25.2.2 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.From.RemoteTable](#rqsrs-032clickhousealtertablereplacepartitionprohibitedfromremotetable)
        * 25.2.3 [Table Functions](#table-functions)
            * 25.2.3.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.From.TableFunctions](#rqsrs-032clickhousealtertablereplacepartitionprohibitedfromtablefunctions)
        * 25.2.4 [Subquery](#subquery)
            * 25.2.4.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.Subquery](#rqsrs-032clickhousealtertablereplacepartitionprohibitedsubquery)
        * 25.2.5 [Join Clause](#join-clause)
            * 25.2.5.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.Join](#rqsrs-032clickhousealtertablereplacepartitionprohibitedjoin)
        * 25.2.6 [Replace Partition From Tables That Do Not Have Partitions](#replace-partition-from-tables-that-do-not-have-partitions)
            * 25.2.6.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.IncorrectTableEngines](#rqsrs-032clickhousealtertablereplacepartitionprohibitedincorrecttableengines)
        * 25.2.7 [View](#view)
            * 25.2.7.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.View.Normal](#rqsrs-032clickhousealtertablereplacepartitionprohibitedviewnormal)
        * 25.2.8 [Materialized View](#materialized-view)
            * 25.2.8.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.View.Materialized](#rqsrs-032clickhousealtertablereplacepartitionprohibitedviewmaterialized)
...
* 26 [Replacing Partitions During Ongoing Merges and Mutations](#replacing-partitions-during-ongoing-merges-and-mutations)
    ...
    * 26.9 [Alter](#alter)
        ...
        * 26.9.4 [Rename Column](#rename-column)
            * 26.9.4.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.RenameColumn](#rqsrs-032clickhousealtertablereplacepartitionconcurrentalterrenamecolumn)
        * 26.9.5 [Comment Column](#comment-column)
            * 26.9.5.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.CommentColumn](#rqsrs-032clickhousealtertablereplacepartitionconcurrentaltercommentcolumn)
        * 26.9.6 [Add Constraint](#add-constraint)
            * 26.9.6.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.AddConstraint](#rqsrs-032clickhousealtertablereplacepartitionconcurrentalteraddconstraint)
