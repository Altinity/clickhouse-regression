...
SRS032_ClickHouse_Alter_Table_Replace_Partition = Specification(
    ...
    headings=(
        ...
        Heading(name="Temporary Tables", level=1, num="10"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.TemporaryTable",
            level=2,
            num="10.1",
        ),
        Heading(name="From Temporary Table", level=2, num="10.2"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.FromTemporaryTable",
            level=3,
            num="10.2.1",
        ),
        Heading(name="From Temporary Table To Temporary Table", level=2, num="10.3"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.ToTemporaryTable",
            level=3,
            num="10.3.1",
        ),
        Heading(name="From Regular Table To Temporary Table", level=2, num="10.4"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.FromRegularTable",
            level=3,
            num="10.4.1",
        ...
        Heading(name="Using Settings With Replace Partition Clause", level=1, num="13"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Settings",
            level=2,
            num="13.1",
        ),
        Heading(name="Table Is on a Separate Disk", level=1, num="14"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Disks",
            level=2,
            num="14.1",
        ),
        Heading(name="Table That Is Stored on S3", level=1, num="15"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.S3",
            level=2,
            num="15.1",
        ...
        Heading(
            name="Destination Table That Is on a Different Replica", level=1, num="16"
        ),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Replicas",
            level=2,
        ...
        Heading(
            name="Destination Table That Is on a Different Shard", level=1, num="17"
        ),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Shards",
            level=2,
        ...
        Heading(name="Table That Has a Different Encoding", level=1, num="19"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Encodings",
            level=2,
            num="19.1",
        ...
        Heading(name="Deduplication Tables", level=1, num="21"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Deduplication",
            level=2,
            num="21.1",
        ...
        Heading(name="Prohibited Actions", level=1, num="25"),
        Heading(name="Actions With From Clause", level=2, num="25.1"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited",
            level=3,
            num="25.1.1",
        ),
        Heading(name="Table Functions", level=3, num="25.1.2"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.TableFunctions",
            level=4,
            num="25.1.2.1",
        ),
        Heading(name="Subquery", level=3, num="25.1.3"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.Subquery",
            level=4,
            num="25.1.3.1",
        ),
        Heading(name="Join Clause", level=3, num="25.1.4"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.Join",
            level=4,
            num="25.1.4.1",
        ...
        Heading(name="View", level=3, num="25.1.6"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.View.Normal",
            level=4,
            num="25.1.6.1",
        ),
        Heading(name="Materialized View", level=3, num="25.1.7"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.View.Materialized",
            level=4,
            num="25.1.7.1",
        ),
        Heading(name="Using Order By and Partition By", level=2, num="25.2"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.OrderAndPartition",
            level=3,
            num="25.2.1",
        ...
        Heading(name="Clear Column", level=3, num="26.9.3"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.Clear",
            level=4,
            num="26.9.3.1",
        ),
        Heading(name="Modify Column", level=3, num="26.9.4"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.Modify",
            level=4,
            num="26.9.4.1",
        ),
        Heading(name="Modify Column Remove", level=3, num="26.9.5"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.ModifyRemove",
            level=4,
            num="26.9.5.1",
        ),
        Heading(name="Materialize", level=3, num="26.9.6"),
        Heading(
            name="RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.Materialize",
            level=4,
            num="26.9.6.1",
...
* 9 [Temporary Tables](#temporary-tables)
    ...
    * 9.2 [From Temporary Table](#from-temporary-table)
...
* 12 [Using Settings With Replace Partition Clause](#using-settings-with-replace-partition-clause)
    * 12.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Settings](#rqsrs-032clickhousealtertablereplacepartitionsettings)
* 13 [Table Is on a Separate Disk](#table-is-on-a-separate-disk)
    * 13.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Disks](#rqsrs-032clickhousealtertablereplacepartitiondisks)
* 14 [Table That Is Stored on S3](#table-that-is-stored-on-s3)
    * 14.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.S3](#rqsrs-032clickhousealtertablereplacepartitions3)
* 15 [Destination Table That Is on a Different Replica](#destination-table-that-is-on-a-different-replica)
    * 15.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Replicas](#rqsrs-032clickhousealtertablereplacepartitionreplicas)
* 16 [Destination Table That Is on a Different Shard](#destination-table-that-is-on-a-different-shard)
    * 16.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Shards](#rqsrs-032clickhousealtertablereplacepartitionshards)
* 17 [Table That Is Stored on a Server With Different ClickHouse Version](#table-that-is-stored-on-a-server-with-different-clickhouse-version)
    * 17.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Versions](#rqsrs-032clickhousealtertablereplacepartitionversions)
* 18 [Table That Has a Different Encoding](#table-that-has-a-different-encoding)
    * 18.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Encodings](#rqsrs-032clickhousealtertablereplacepartitionencodings)
...
* 20 [Deduplication Tables](#deduplication-tables)
    * 20.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Deduplication](#rqsrs-032clickhousealtertablereplacepartitiondeduplication)
...
* 24 [Prohibited Actions](#prohibited-actions)
    * 24.1 [Actions With From Clause](#actions-with-from-clause)
        * 24.1.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited](#rqsrs-032clickhousealtertablereplacepartitionprohibited)
        * 24.1.2 [Table Functions](#table-functions)
            * 24.1.2.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.TableFunctions](#rqsrs-032clickhousealtertablereplacepartitionprohibitedtablefunctions)
        * 24.1.3 [Subquery](#subquery)
            * 24.1.3.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.Subquery](#rqsrs-032clickhousealtertablereplacepartitionprohibitedsubquery)
        * 24.1.4 [Join Clause](#join-clause)
            * 24.1.4.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.Join](#rqsrs-032clickhousealtertablereplacepartitionprohibitedjoin)
        * 24.1.5 [Replace Partition From Tables That Do Not Have Partitions](#replace-partition-from-tables-that-do-not-have-partitions)
            * 24.1.5.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.IncorrectTableEngines](#rqsrs-032clickhousealtertablereplacepartitionprohibitedincorrecttableengines)
        * 24.1.6 [View](#view)
            * 24.1.6.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.View.Normal](#rqsrs-032clickhousealtertablereplacepartitionprohibitedviewnormal)
        * 24.1.7 [Materialized View](#materialized-view)
            * 24.1.7.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.View.Materialized](#rqsrs-032clickhousealtertablereplacepartitionprohibitedviewmaterialized)
    * 24.2 [Using Order By and Partition By](#using-order-by-and-partition-by)
        * 24.2.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Prohibited.OrderAndPartition](#rqsrs-032clickhousealtertablereplacepartitionprohibitedorderandpartition)
* 25 [Replacing Partitions During Ongoing Merges and Mutations](#replacing-partitions-during-ongoing-merges-and-mutations)
    ...
    * 25.9 [Alter](#alter)
        ...
        * 25.9.3 [Clear Column](#clear-column)
            * 25.9.3.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.Clear](#rqsrs-032clickhousealtertablereplacepartitionconcurrentalterclear)
        * 25.9.4 [Modify Column](#modify-column)
            * 25.9.4.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.Modify](#rqsrs-032clickhousealtertablereplacepartitionconcurrentaltermodify)
        * 25.9.5 [Modify Column Remove](#modify-column-remove)
            * 25.9.5.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.ModifyRemove](#rqsrs-032clickhousealtertablereplacepartitionconcurrentaltermodifyremove)
        * 25.9.6 [Materialize](#materialize)
            * 25.9.6.1 [RQ.SRS-032.ClickHouse.Alter.Table.ReplacePartition.Concurrent.Alter.Materialize](#rqsrs-032clickhousealtertablereplacepartitionconcurrentaltermaterialize)
