...
SRS038_ClickHouse_Alter_Table_Move_Partition = Specification(
    ...
    headings=(
        ...
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition', level=2, num='4.1'),
        Heading(name='Supported Table Engines', level=1, num='5'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.SupportedTableEngines', level=2, num='5.1'),
        Heading(name='Storage Policies', level=1, num='6'),
        Heading(name='Table That Is Stored on S3  ', level=2, num='6.1'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.S3', level=3, num='6.1.1'),
        Heading(name='Table That Is Stored on Tiered Storage  ', level=2, num='6.2'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.TieredStorage', level=3, num='6.2.1'),
        Heading(name='Partition Types', level=1, num='7'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.PartitionTypes', level=2, num='7.1'),
        Heading(name='Corrupted Parts ', level=1, num='8'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.CorruptedParts', level=2, num='8.1'),
        Heading(name='Table names', level=1, num='9'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.TableName', level=2, num='9.1'),
        ...
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.DeleteData', level=3, num='9.3.1'),
        Heading(name='Temporary Tables', level=2, num='9.4'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.FromTemporaryTable', level=3, num='9.4.1'),
        Heading(name='Destination Table That Is on a Different Replica', level=2, num='9.5'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.Replicas', level=3, num='9.5.1'),
        Heading(name='Destination Table That Is on a Different Shard', level=2, num='9.6'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.Shards', level=3, num='9.6.1'),
        Heading(name='Conditions when Move Partition ', level=2, num='9.7'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.Conditions', level=3, num='9.7.1'),
        Heading(name='Tables With The Same Structure', level=3, num='9.7.2'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.Conditions.Same.Structure', level=4, num='9.7.2.1'),
        Heading(name='Tables With The Same `ORDER BY` Key', level=3, num='9.7.3'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.Conditions.Same.Key.OrderByKey', level=4, num='9.7.3.1'),
        Heading(name='Tables With The Same Primary Key', level=3, num='9.7.4'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.Conditions.Same.Key.PrimaryKey', level=4, num='9.7.4.1'),
        Heading(name='Tables With The Same Storage Policy', level=3, num='9.7.5'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.Conditions.Same.StoragePolicy', level=4, num='9.7.5.1'),
        Heading(name='Tables With The Same Indices and Projections', level=3, num='9.7.6'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.Conditions.Same.IndicesAndProjections', level=4, num='9.7.6.1'),
        Heading(name='Partition Key Conditions', level=3, num='9.7.7'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.Conditions.Key.PartitionKey', level=4, num='9.7.7.1'),
        Heading(name='Role-Based Access Control when Move Partition', level=2, num='9.8'),
        Heading(name='RQ.SRS-038.ClickHouse.Alter.Table.MovePartition.RBAC', level=3, num='9.8.1'),
