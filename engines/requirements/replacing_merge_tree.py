...
SRS035_ClickHouse_ReplacingMergeTree = Specification(
    ...
    headings=(
        ...
        Heading(
            name="RQ.SRS-035.ClickHouse.ReplacingMergeTree.DataDeduplication",
            level=3,
            num="4.1.3",
        ),
        Heading(
            name="RQ.SRS-035.ClickHouse.ReplacingMergeTree.OptimizeMerge",
            level=3,
            num="4.1.4",
        ),
        Heading(
            name="RQ.SRS-035.ClickHouse.ReplacingMergeTree.UniquenessOfRows",
            level=3,
            num="4.1.5",
        ),
        Heading(
        ...
        Heading(
            name="RQ.SRS-035.ClickHouse.ReplacingMergeTree.Update", level=3, num="4.4.1"
        ),
        Heading(name="Delete", level=2, num="4.5"),
        Heading(
            name="RQ.SRS-035.ClickHouse.ReplacingMergeTree.Delete", level=3, num="4.5.1"
        ),
        Heading(
            name="RQ.SRS-035.ClickHouse.ReplacingMergeTree.DeleteDisabled",
            level=3,
