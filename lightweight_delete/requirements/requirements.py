...
RQ_SRS_023_ClickHouse_LightweightDelete_Backups_BackupPartition = Requirement(
    name="RQ.SRS-023.ClickHouse.LightweightDelete.Backups.BackupPartition",
    version="1.0",
    priority=None,
    group=None,
    type=None,
...
SRS023_ClickHouse_Lightweight_Delete = Specification(
    ...
    requirements=(
        ...
        RQ_SRS_023_ClickHouse_LightweightDelete_DiskSpace,
        ...
        RQ_SRS_023_ClickHouse_LightweightDelete_Backups_Mask,
        RQ_SRS_023_ClickHouse_LightweightDelete_Backups_BackupAfterLightweightDelete,
        RQ_SRS_023_ClickHouse_LightweightDelete_Backups_BackupPartition,
        ...
        RQ_SRS_023_ClickHouse_LightweightDelete_Load_Merges,
...
* 2 [Requirements](#requirements)
  ...
  * 2.28 [Acceptance Criteria Using Reference `OnTime` Dataset](#acceptance-criteria-using-reference-ontime-dataset)
  ...
  * 2.30 [Compatibility](#compatibility)
    * 2.30.1 [Concurrent Operations](#concurrent-operations)
      ...
      * 2.30.1.4 [Concurrent Delete & Alter Delete](#concurrent-delete-alter-delete)
        * 2.30.1.4.1 [RQ.SRS-023.ClickHouse.LightweightDelete.Compatibility.ConcurrentDelete&AlterDelete](#rqsrs-023clickhouselightweightdeletecompatibilityconcurrentdeletealterdelete)
