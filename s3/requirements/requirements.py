...
SRS_015_ClickHouse_S3_External_Storage = Specification(
    ...
    headings=(
        ...
        Heading(
            name="RQ.SRS-015.S3.AutomaticReconnects.Azure", level=4, num="4.1.17.4"
        ),
        ...
        Heading(
            name="RQ.SRS-015.S3.TableFunction.S3Cluster.Syntax", level=3, num="4.6.4"
        ),
        Heading(
            name="RQ.SRS-015.S3.TableFunction.S3Cluster.ClusterName",
            level=3,
        ...
        Heading(
            name="RQ.SRS-015.S3.TableFunction.Credentials.Invalid", level=3, num="4.6.8"
        ),
        ...
        Heading(
            name="RQ.SRS-015.S3.TableFunction.MeasureFileSize", level=3, num="4.6.14"
        ),
        Heading(name="RQ.SRS-015.S3.TableFunction.Compression", level=3, num="4.6.15"),
        Heading(
            name="RQ.SRS-015.S3.TableFunction.Compression.Auto", level=3, num="4.6.16"
        ),
        Heading(
            name="RQ.SRS-015.S3.TableFunction.S3Cluster.remote", level=3, num="4.6.17"
        ),
        Heading(
            name="RQ.SRS-015.S3.TableFunction.S3Cluster.HivePartitioning",
            level=3,
