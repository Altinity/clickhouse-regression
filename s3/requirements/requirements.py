...
RQ_SRS_015_S3_TableFunction_S3 = Requirement(
    name='RQ.SRS-015.S3.TableFunction.S3',
    version='1.0',
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_015_S3_TableFunction_S3_Syntax = Requirement(
    name='RQ.SRS-015.S3.TableFunction.S3.Syntax',
    version='1.0',
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_015_S3_TableFunction_S3Cluster_Syntax = Requirement(
    name='RQ.SRS-015.S3.TableFunction.S3Cluster.Syntax',
    version='1.0',
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_015_S3_TableFunction_S3Cluster_ClusterName = Requirement(
    name='RQ.SRS-015.S3.TableFunction.S3Cluster.ClusterName',
    version='1.0',
    priority=None,
    group=None,
    type=None,
...
RQ_SRS_015_S3_TableFunction_S3Cluster_remote = Requirement(
    name='RQ.SRS-015.S3.TableFunction.S3Cluster.remote',
    version='1.0',
    priority=None,
    group=None,
    type=None,
    uid=None,
    description=(
        '[ClickHouse] SHALL support remote call for `s3Cluster` function:\n'
        '\n'
...
RQ_SRS_015_S3_TableFunction_S3Cluster_HivePartitioning = Requirement(
    name='RQ.SRS-015.S3.TableFunction.S3Cluster.HivePartitioning',
    version='1.0',
    priority=None,
    group=None,
    type=None,
...
SRS_015_ClickHouse_S3_External_Storage = Specification(
    ...
    headings=(
        ...
        Heading(name='RQ.SRS-015.S3.DataParts', level=3, num='4.1.6'),
        Heading(name='RQ.SRS-015.S3.Security.Encryption', level=3, num='4.1.7'),
        Heading(name='RQ.SRS-015.S3.RemoteHostFilter', level=3, num='4.1.8'),
        Heading(name='RQ.SRS-015.S3.Alter', level=3, num='4.1.9'),
        ...
        Heading(name='RQ.SRS-015.S3.Backup.AzureBackup', level=4, num='4.1.10.4'),
        Heading(name='RQ.SRS-015.S3.Backup.StoragePolicies', level=4, num='4.1.10.5'),
        Heading(name='RQ.SRS-015.S3.Backup.AlterFreeze', level=4, num='4.1.10.6'),
        Heading(name='RQ.SRS-015.S3.Backup.AlterDetach', level=4, num='4.1.10.7'),
        Heading(name='RQ.SRS-015.S3.Backup.AlterAttach', level=4, num='4.1.10.8'),
        Heading(name='RQ.SRS-015.S3.Backup.Cleanup', level=4, num='4.1.10.9'),
        ...
        Heading(name='RQ.SRS-0.5.S3.MetadataRestore.RestoreFile', level=4, num='4.1.12.1'),
        Heading(name='RQ.SRS-0.5.S3.MetadataRestore.BadRestoreFile', level=4, num='4.1.12.2'),
        Heading(name='RQ.SRS-0.5.S3.MetadataRestore.HugeRestoreFile', level=4, num='4.1.12.3'),
        Heading(name='RQ.SRS-015.S3.MetadataRestore.NoLocalMetadata', level=4, num='4.1.12.4'),
        Heading(name='RQ.SRS-015.S3.MetadataRestore.BucketPath', level=4, num='4.1.12.5'),
        Heading(name='RQ.SRS-015.S3.MetadataRestore.RevisionRestore', level=4, num='4.1.12.6'),
        Heading(name='RQ.SRS-015.S3.MetadataRestore.Mutations', level=4, num='4.1.12.7'),
        Heading(name='RQ.SRS-015.S3.MetadataRestore.ParallelMutations', level=4, num='4.1.12.8'),
        ...
        Heading(name='RQ.SRS-015.S3.Azure', level=3, num='4.1.16'),
        ...
        Heading(name='RQ.SRS-015.S3.AutomaticReconnects.MinIO', level=4, num='4.1.17.3'),
        Heading(name='RQ.SRS-015.S3.AutomaticReconnects.Azure', level=4, num='4.1.17.4'),
        ...
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.Invalid', level=4, num='4.4.7.3'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.Changes.NoRestart', level=4, num='4.4.7.4'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.Access', level=4, num='4.4.7.5'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.Access.Default', level=4, num='4.4.7.6'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.CacheEnabled', level=4, num='4.4.7.7'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.CacheEnabled.Default', level=4, num='4.4.7.8'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.Cache.22.8', level=4, num='4.4.7.9'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.Cache.22.8.CacheOnWriteOperations', level=4, num='4.4.7.10'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.Cache.22.8.DataCacheMaxSize', level=4, num='4.4.7.11'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.Cache.22.8.EnableCacheHitsThreshold', level=4, num='4.4.7.12'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.Cache.22.8.FileSystemQueryCacheLimit', level=4, num='4.4.7.13'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.CachePath', level=4, num='4.4.7.14'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.CachePath.Conflict', level=4, num='4.4.7.15'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.MinBytesForSeek', level=4, num='4.4.7.16'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.MinBytesForSeek.Syntax', level=4, num='4.4.7.17'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.S3MaxSinglePartUploadSize', level=4, num='4.4.7.18'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.S3MaxSinglePartUploadSize.Syntax', level=4, num='4.4.7.19'),
        Heading(name='RQ.SRS-015.S3.Disk.Configuration.S3UseEnvironmentCredentials', level=4, num='4.4.7.20'),
        ...
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.ReplacingMergeTree', level=4, num='4.4.8.3'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.SummingMergeTree', level=4, num='4.4.8.4'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AggregatingMergeTree', level=4, num='4.4.8.5'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.CollapsingMergeTree', level=4, num='4.4.8.6'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.VersionedCollapsingMergeTree', level=4, num='4.4.8.7'),
        Heading(name='S3 Zero Copy Replication', level=4, num='4.4.8.8'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication', level=5, num='4.4.8.8.1'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.Default', level=5, num='4.4.8.8.2'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.Global', level=5, num='4.4.8.8.3'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.Metadata', level=5, num='4.4.8.8.4'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.Alter', level=5, num='4.4.8.8.5'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.Delete', level=5, num='4.4.8.8.6'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.DeleteAll', level=5, num='4.4.8.8.7'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.DataPreservedAfterMutation', level=5, num='4.4.8.8.8'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.DropReplica', level=5, num='4.4.8.8.9'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.AddReplica', level=5, num='4.4.8.8.10'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.NoDataDuplication', level=5, num='4.4.8.8.11'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.TTL.Move', level=5, num='4.4.8.8.12'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.TTL.Delete', level=5, num='4.4.8.8.13'),
        ...
        Heading(name='RQ.SRS-015.S3.TableFunction.S3', level=3, num='4.6.1'),
        Heading(name='RQ.SRS-015.S3.TableFunction.S3Cluster', level=3, num='4.6.2'),
        Heading(name='RQ.SRS-015.S3.TableFunction.S3.Syntax', level=3, num='4.6.3'),
        Heading(name='RQ.SRS-015.S3.TableFunction.S3Cluster.Syntax', level=3, num='4.6.4'),
        Heading(name='RQ.SRS-015.S3.TableFunction.S3Cluster.ClusterName', level=3, num='4.6.5'),
        Heading(name='RQ.SRS-015.S3.TableFunction.Path', level=3, num='4.6.6'),
        Heading(name='RQ.SRS-015.S3.TableFunction.Credentials', level=3, num='4.6.7'),
        Heading(name='RQ.SRS-015.S3.TableFunction.Credentials.Invalid', level=3, num='4.6.8'),
        Heading(name='RQ.SRS-015.S3.TableFunction.Path.Glob', level=3, num='4.6.9'),
        Heading(name='RQ.SRS-015.S3.TableFunction.ReadFromFile', level=3, num='4.6.10'),
        Heading(name='RQ.SRS-015.S3.TableFunction.Redirect', level=3, num='4.6.11'),
        Heading(name='RQ.SRS-015.S3.TableFunction.Format', level=3, num='4.6.12'),
        Heading(name='RQ.SRS-015.S3.TableFunction.Structure', level=3, num='4.6.13'),
        Heading(name='RQ.SRS-015.S3.TableFunction.MeasureFileSize', level=3, num='4.6.14'),
        Heading(name='RQ.SRS-015.S3.TableFunction.Compression', level=3, num='4.6.15'),
        Heading(name='RQ.SRS-015.S3.TableFunction.Compression.Auto', level=3, num='4.6.16'),
        Heading(name='RQ.SRS-015.S3.TableFunction.S3Cluster.remote', level=3, num='4.6.17'),
        Heading(name='RQ.SRS-015.S3.TableFunction.S3Cluster.HivePartitioning', level=3, num='4.6.18'),
        ...
        Heading(name='RQ.SRS-015.S3.Azure.AllowS3ZeroCopyReplication', level=3, num='4.10.2'),
        Heading(name='Settings', level=2, num='4.11'),
        Heading(name='RQ.SRS-015.S3.Settings.MaxThreads', level=3, num='4.11.1'),
        Heading(name='RQ.SRS-015.S3.Settings.MaxDownloadThreads', level=3, num='4.11.2'),
        Heading(name='RQ.SRS-015.S3.Settings.MaxDownloadBufferSize', level=3, num='4.11.3'),
        Heading(name='RQ.SRS-015.S3.Settings.PartitionBy', level=3, num='4.11.4'),
        Heading(name='RQ.SRS-015.S3.Settings.S3UploadPartSizeMultiplyFactor', level=3, num='4.11.5'),
        Heading(name='RQ.SRS-015.S3.Settings.S3UploadPartSizeMultiplyPartsCountThreshold', level=3, num='4.11.6'),
        Heading(name='Performance', level=2, num='4.12'),
        Heading(name='RQ.SRS-015.S3.Performance.PerformTTLMoveOnInsert', level=3, num='4.12.1'),
        Heading(name='RQ.SRS-015.S3.Performance.Glob', level=3, num='4.12.2'),
        Heading(name='RQ.SRS-015.S3.Performance.AllowS3ZeroCopyReplication.Select', level=3, num='4.12.3'),
        Heading(name='RQ.SRS-015.S3.Performance.AllowS3ZeroCopyReplication.Insert', level=3, num='4.12.4'),
        Heading(name='RQ.SRS-015.S3.Performance.AllowS3ZeroCopyReplication.Alter', level=3, num='4.12.5'),
    ...
    requirements=(
        ...
        RQ_SRS_015_S3_TableFunction_S3,
        RQ_SRS_015_S3_TableFunction_S3Cluster,
        RQ_SRS_015_S3_TableFunction_S3_Syntax,
        RQ_SRS_015_S3_TableFunction_S3Cluster_Syntax,
        RQ_SRS_015_S3_TableFunction_S3Cluster_ClusterName,
        ...
        RQ_SRS_015_S3_TableFunction_S3Cluster_remote,
        RQ_SRS_015_S3_TableFunction_S3Cluster_HivePartitioning,
