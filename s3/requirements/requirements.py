...
SRS_015_ClickHouse_S3_External_Storage = Specification(
    ...
    headings=(
        ...
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.DropReplica', level=5, num='4.4.7.8.8'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.AddReplica', level=5, num='4.4.7.8.9'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.NoDataDuplication', level=5, num='4.4.7.8.10'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.TTL.Move', level=5, num='4.4.7.8.11'),
        Heading(name='RQ.SRS-015.S3.Disk.MergeTree.AllowS3ZeroCopyReplication.TTL.Delete', level=5, num='4.4.7.8.12'),
