...
def packet_delay(self, delay_ms):
    ...
    with And("I export partitions from the source table to the S3 table"):
        export_partitions(
...
def packet_duplication(self, percent_duplicated):
    """Check that exports work correctly with packet duplication."""
...
def packet_reordering(self, delay_ms, percent_reordered):
    """Check that exports work correctly with packet reordering."""
...
def packet_rate_limit(self, rate_mbit):
    """Check that exports work correctly with packet rate limit."""
...
def minio_interruption(self, strategy, signal):
    ...
    with And("I get partitions before the interruption"):
