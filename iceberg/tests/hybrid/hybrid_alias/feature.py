...
def feature(self, minio_root_user, minio_root_password):
    ...
    with Feature("arithmetic"):
        ...
        test_features = discover_test_features(
            current_dir=arithmetic_dir, subdirectory="arithmetic"
        )
        run_tests(
            test_features,
    ...
    with Feature("constants"):
        ...
        test_features = discover_test_features(
            current_dir=constants_dir, subdirectory="constants"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("math functions"):
        ...
        test_features = discover_test_features(
            current_dir=math_functions_dir, subdirectory="math_functions"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("rounding functions"):
        ...
        test_features = discover_test_features(
            current_dir=rounding_functions_dir, subdirectory="rounding_functions"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("boolean logical"):
        ...
        test_features = discover_test_features(
            current_dir=boolean_logical_dir, subdirectory="boolean_logical"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("datetime functions"):
        ...
        test_features = discover_test_features(
            current_dir=datetime_functions_dir, subdirectory="datetime_functions"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("string functions"):
        ...
        test_features = discover_test_features(
            current_dir=string_functions_dir, subdirectory="string_functions"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("type conversions"):
        ...
        test_features = discover_test_features(
            current_dir=type_conversions_dir, subdirectory="type_conversions"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("nested dependent"):
        ...
        test_features = discover_test_features(
            current_dir=nested_dependent_dir, subdirectory="nested_dependent"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("utility functions"):
        ...
        test_features = discover_test_features(
            current_dir=utility_functions_dir, subdirectory="utility_functions"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("complex expressions"):
        ...
        test_features = discover_test_features(
            current_dir=complex_expressions_dir, subdirectory="complex_expressions"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("array functions"):
        ...
        test_features = discover_test_features(
            current_dir=array_functions_dir, subdirectory="array_functions"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("tuple functions"):
        ...
        test_features = discover_test_features(
            current_dir=tuple_functions_dir, subdirectory="tuple_functions"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("map functions"):
        ...
        test_features = discover_test_features(
            current_dir=map_functions_dir, subdirectory="map_functions"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("json functions"):
        ...
        test_features = discover_test_features(
            current_dir=json_functions_dir, subdirectory="json_functions"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("hash encoding functions"):
        ...
        test_features = discover_test_features(
            current_dir=hash_encoding_functions_dir,
            subdirectory="hash_encoding_functions",
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
    ...
    with Feature("query context"):
        ...
        test_features = discover_test_features(
            current_dir=query_context_dir, subdirectory="query_context"
        )
        run_tests(
            test_features,
            minio_root_user=minio_root_user,
