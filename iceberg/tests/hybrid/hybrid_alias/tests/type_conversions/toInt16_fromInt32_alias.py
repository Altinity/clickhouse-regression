...
@TestScenario
def toInt16_fromInt32_alias_in_watermark(self):
    """
    Define parameters for test case and call main outline.
    Test alias: value_int16 ALIAS toInt16(value) - Shrinking conversion from Int32 to Int16
    ...
    watermark = {
        "left_predicate": "value_int16 >= 5000",
        "right_predicate": "value_int16 < 5000",
    }
    expected = {"exitcode": 0, "error_message": None}
    test_queries = [
        "SELECT id, value, date_col FROM {hybrid_table} ORDER BY id",
...
def feature(self, minio_root_user=None, minio_root_password=None):
    ...
    Scenario(run=toInt16_fromInt32_alias_in_watermark)
