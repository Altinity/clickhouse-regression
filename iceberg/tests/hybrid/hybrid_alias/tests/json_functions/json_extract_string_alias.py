...
def json_extract_string_alias(self):
    ...
    alias_columns = [
        {
            ...
            "expression": "JSONExtractString(toString(json_col), 'key')",
            "hybrid_type": "String",
        },
    ]
    watermark = {
    ...
    test_queries = [
        ...
        "SELECT json_extract_string FROM {hybrid_table} ORDER BY id",
        "SELECT id, value, json_extract_string FROM {hybrid_table} ORDER BY id",
    ]
