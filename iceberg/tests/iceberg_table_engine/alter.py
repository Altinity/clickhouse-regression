...
def alter_column(self, minio_root_user, minio_root_password, node=None):
    ...
    with Then("try to add new column to ClickHouse table with Iceberg engine"):
        exitcode = 48
        message = "DB::Exception: Alter of type 'ADD_COLUMN' is not supported by storage IcebergS3. (NOT_IMPLEMENTED)"
        node.query(
    ...
    with And("try to drop column from ClickHouse table with Iceberg engine"):
        exitcode = 48
        message = "DB::Exception: Alter of type 'DROP_COLUMN' is not supported by storage IcebergS3. (NOT_IMPLEMENTED)"
        node.query(
    ...
    with And("try to rename column in ClickHouse table with Iceberg engine"):
        exitcode = 48
        message = "DB::Exception: Alter of type 'RENAME_COLUMN' is not supported by storage IcebergS3. (NOT_IMPLEMENTED)"
        node.query(
    ...
    with And("try to modify column in ClickHouse table with Iceberg engine"):
        exitcode = 48
        message = "DB::Exception: Alter of type 'MODIFY_COLUMN' is not supported by storage IcebergS3. (NOT_IMPLEMENTED)"
        node.query(
...
def alter_comment_columns(self, minio_root_user, minio_root_password, node=None):
    ...
    with Then("comment columns in ClickHouse table with Iceberg engine"):
        ...
        result = node.query(f"DESCRIBE TABLE {iceberg_table_name}").output
    ...
    with And("try to remove comment"):
        ...
        message = "DB::Exception: Alter of type 'MODIFY_COLUMN' is not supported by storage IcebergS3. (NOT_IMPLEMENTED)"
        node.query(
            f"ALTER TABLE {iceberg_table_name} MODIFY COLUMN long_col REMOVE COMMENT",
            exitcode=exitcode,
            message=message,
        )
...
def alter_settings(self, minio_root_user, minio_root_password, node=None):
    ...
    with Then("try to modify settings in ClickHouse table with Iceberg engine"):
        exitcode = 48
        message = "DB::Exception: Alter of type 'MODIFY_SETTING' is not supported by storage IcebergS3. (NOT_IMPLEMENTED)"
        node.query(
...
def alter_order_by(self, minio_root_user, minio_root_password, node=None):
    ...
    with Then("try to use ORDER BY in ClickHouse table with Iceberg engine"):
        exitcode = 48
        message = "DB::Exception: Received from localhost:9000. DB::Exception: Alter of type 'MODIFY_ORDER_BY' is not supported by storage IcebergS3. (NOT_IMPLEMENTED)"
        node.query(
