...
def create_partitioned_table(
    ...
    try:
        with Given(f"I have a table {table_name}"):
            node.query(
                f"CREATE TABLE {table_name} {cluster} (id Int64, x String{extra_table_col})"
...
def delete_query_1_ontime(self, node=None):
    ...
    delete(table_name="datasets.ontime", condition="Year = 1990")
...
def delete_query_2_ontime(self, node=None):
    ...
    delete(table_name="datasets.ontime", condition="Year % 2 = 0")
...
def delete_query_3_ontime(self, node=None):
    ...
    delete(table_name="datasets.ontime", condition="Month = 2")
...
def delete_query_4_ontime(self, node=None):
    ...
    delete(table_name="datasets.ontime", condition="DayofMonth = 2")
...
def delete_query_5_ontime(self, node=None):
    ...
    delete(table_name="datasets.ontime", condition="FlightDate = '2020-01-01'")
