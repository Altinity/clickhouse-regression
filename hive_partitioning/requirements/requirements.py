...
SRS_045_Hive_Partitioning = Specification(
    ...
    headings=(
        ...
        Heading(name='RQ.HivePartitioning.VirtualColumns.Appearance', level=2, num='3.3'),
        Heading(name='RQ.HivePartitioning.VirtualColumns.Accessibility', level=2, num='3.4'),
        Heading(name='RQ.HivePartitioning.VirtualColumns.InvalidPath', level=2, num='3.5'),
        Heading(name='RQ.HivePartitioning.VirtualColumns.NameConflict', level=2, num='3.6'),
        Heading(name='RQ.HivePartitioning.VirtualColumns.HiveDisabled', level=2, num='3.7'),
        Heading(name='RQ.HivePartitioning.VirtualColumns.NonExistingKey', level=2, num='3.8'),
        Heading(name='Hive Partition Types Value', level=1, num='4'),
        Heading(name='RQ.HivePartitioning.HivePartitionValue', level=2, num='4.1'),
        Heading(name='RQ.HivePartitioning.HivePartitionValue.EmptyValue', level=2, num='4.2'),
        ...
        Heading(name='RQ.HivePartitioning.Writes.PartitionStrategy', level=3, num='8.2.1'),
        Heading(name='RQ.HivePartitioning.Writes.PartitionStrategyWrongArgument', level=3, num='8.2.2'),
        Heading(name='Partition Columns In Data File Parameter', level=2, num='8.3'),
        Heading(name='RQ.HivePartitioning.Writes.PartitionColumnsInDataFile', level=3, num='8.3.1'),
        Heading(name='RQ.HivePartitioning.Writes.PartitionColumnsInDataFileWithoutHivePartitionStrategy', level=3, num='8.3.2'),
        Heading(name='RQ.HivePartitioning.Writes.PartitionColumnsInDataFileWrongArgument', level=3, num='8.3.3'),
        ...
        Heading(name='RQ.HivePartitioning.Writes.FilenameWithoutHivePartitionStrategy', level=3, num='8.5.2'),
        Heading(name='RQ.HivePartitioning.Writes.NotDefinedFilename', level=3, num='8.5.3'),
        Heading(name='S3 Engine Parameters', level=2, num='8.6'),
        Heading(name='RQ.HivePartitioning.Writes.S3EngineParameters', level=3, num='8.6.1'),
        Heading(name='RQ.HivePartitioning.Writes.UseHivePartitions', level=3, num='8.6.2'),
        Heading(name='Writes By Partitions And Parts', level=2, num='8.7'),
        Heading(name='RQ.HivePartitioning.Writes.PartitionsParts', level=3, num='8.7.1'),
        ...
        Heading(name='RQ.HivePartitioning.Writes.NullableDataType', level=3, num='8.12.1'),
        Heading(name='Supported Data Types', level=2, num='8.13'),
        Heading(name='RQ.HivePartitioning.Writes.SupportedDataTypes', level=3, num='8.13.1'),
        Heading(name='Unsupported Types', level=2, num='8.14'),
        Heading(name='RQ.HivePartitioning.Writes.DataTypesUnsupported', level=3, num='8.14.1'),
        Heading(name='Using ReadOnly Bucket', level=2, num='8.15'),
        Heading(name='RQ.HivePartitioning.Writes.ReadOnlyBucket', level=3, num='8.15.1'),
        Heading(name='Non-Accessible Bucket', level=2, num='8.16'),
        Heading(name='RQ.HivePartitioning.Writes.NonAccessibleBucket', level=3, num='8.16.1'),
        Heading(name='Parallel Inserts', level=2, num='8.17'),
        Heading(name='RQ.HivePartitioning.Writes.ParallelInserts', level=3, num='8.17.1'),
