...
Results for **the latest** scheduled workflow runs. Scheduled runs use **x86 only**, except ClickHouse **head**, which also runs on **arm64**.
...
- **All other versions** run once a week at 22:00 UTC on Saturday (x86 only).
