...
SRS033_ClickHouse_Automatic_Final_Modifier_For_Select_Queries = Specification(
    ...
    headings=(
        ...
        Heading(name='RQ.SRS-033.ClickHouse.SelectFinal.FinalModifier', level=4, num='3.3.0.1'),
        ...
        Heading(name='RQ.SRS-033.ClickHouse.SelectFinal.SelectAutoFinalSetting', level=3, num='4.2.2'),
        Heading(name='Supported Table Engines', level=2, num='4.3'),
        Heading(name='MergeTree', level=3, num='4.3.1'),
        Heading(name='RQ.SRS-033.ClickHouse.SelectFinal.SupportedTableEngines', level=4, num='4.3.1.1'),
        ),
    requirements=(
